...
export const translations = {
  hu: {
    ...
    wifiTesting: 'Tesztelés folyamatban...',
    wifiTestSuccess: 'Sikeresen csatlakozva!',
    wifiTestFailed: 'Sikertelen csatlakozás',
    back: 'Vissza',
    skip: 'Kihagyás',
    retry: 'Újra próbálni',
    next: 'Tovább',
  ...
  en: {
    ...
    wifiTesting: 'Testing...',
    wifiTestSuccess: 'Connected successfully!',
    wifiTestFailed: 'Connection failed',
    back: 'Back',
    skip: 'Skip',
    retry: 'Retry',
    next: 'Next',
